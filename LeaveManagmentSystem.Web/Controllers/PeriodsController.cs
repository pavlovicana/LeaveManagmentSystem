...
namespace LeaveManagmentSystem.Web.Controllers
{
    ...
    public class PeriodsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StartDate,EndDate,Id")] Period period)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StartDate,EndDate,Id")] Period period)
        {
            if (id != period.Id)
            {
                return NotFound();
